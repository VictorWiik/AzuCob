...
export default function Receivables() {
  ...
  const openBoleto = (url: string | null) => {
    if (url) {
      ...
      toast.error('Boleto não disponível. Clique em "Sincronizar GestãoClick" para atualizar.')
    }
  }
                      ...
                      <td className="px-6 py-4">
                        <div className="flex gap-1">
                          ...
                          <button
                            ...
                            title={receivable.boletoUrl ? 'Ver Boleto' : 'Boleto não disponível - Sincronize para atualizar'}
                          >
